...
class ManagerModelTest(TestCase):
    ...
    def test_manager_user_relation(self):
        """Тест связи пользователя и менеджера."""

        self.assertEqual(self.manager.user, self.manager_user)
...
class EmployeeModelTest(TestCase):
    ...
    def test_employee_manager_relation(self):
        """Тест связи сотрудника и руководителя."""

        self.assertEqual(self.employee.head, self.manager)
...
class MentorEmployeeModelTest(TestCase):
